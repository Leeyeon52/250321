...
def main():
    # 데이터를 불러옵니다.
    x_train, y_train, x_val, y_val = preprocess.load_data(r'C:\Users\302-15\Desktop\새 폴더\2025-ML-practice\q3\data\iris.csv', independent_var = ['petal length', 'sepal length'], response_var = 'class_num' )
    
    # <ToDo>: svm.py 안의 함수를 사용해 SVM 모델을 불러오고 학습시킵니다.
    clf_svm = train_model(x_train, y_train)
    ...
    mean_acc = evaluate_model(clf_svm, x_val, y_val)
